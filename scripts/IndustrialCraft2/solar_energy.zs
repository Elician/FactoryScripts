...
recipes.addShaped(mirror * 2, [
    [<ore:blockGlass>, <ore:blockGlass>, <ore:blockGlass>], 
    [<minecraft:gunpowder>, <ic2:purified:2>, <minecraft:gunpowder>]
]);
recipes.addShaped(photo1, [
    [<ore:blockGlass>, <ore:blockGlass>, <ore:blockGlass>],
    [<ic2:dust:9>, <ic2:dust:9>, <ic2:dust:9>], 
...
recipes.addShaped(<ic2:crafting:62>, [
    [<ore:blockGlassColorless>, <ore:blockGlassColorless>, <ore:blockGlassColorless>],
    [<extendedcrafting:material:7>, <ic2:misc_resource:1>, <extendedcrafting:material:7>], 
    [<appliedenergistics2:quartz_glass>, <ic2:crafting:61>, <appliedenergistics2:quartz_glass>]
]);

recipes.addShaped(<ic2:crafting:63>, [
    [<minecraft:blaze_powder>, <minecraft:blaze_rod>, <minecraft:blaze_powder>],
    [<extendedcrafting:material:7>, <ic2:dust:6>, <extendedcrafting:material:7>], 
    [<minecraft:stone_slab:7>, <ic2:crafting:62>, <minecraft:stone_slab:7>]
]);
